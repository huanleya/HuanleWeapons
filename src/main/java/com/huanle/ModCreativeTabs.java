    ...
    public static final RegistryObject<CreativeModeTab> HUANLE_TAB = CREATIVE_MODE_TABS.register("huanle_tab",
        () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ModItems.FIRE_GOD_SWORD.get());
    ...
    public static final RegistryObject<CreativeModeTab> HUANLE_MATERIALS_TAB = CREATIVE_MODE_TABS.register("huanle_materials_tab",
        () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ModItems.EARTH_RUNE.get());
                output.accept(ModItems.ELECTRIC_RUNE.get());
                output.accept(ModItems.WIND_RUNE.get());
                output.accept(ModItems.FIRE_RUNE.get());
                output.accept(ModItems.LIFE_RUNE.get());
                output.accept(ModItems.WATER_RUNE.get());
                output.accept(ModItems.CRIMSON_RUNE.get());
                output.accept(ModItems.RUNE_BAG.get());
            })
            .build());
    ...
    public static final RegistryObject<CreativeModeTab> HUANLE_CURIOS_TAB = CREATIVE_MODE_TABS.register("huanle_curios_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModItems.METEORITE_RING.get());
                        output.accept(ModItems.GOLD_ELEMENT_RING.get());
                        output.accept(ModItems.WOOD_ELEMENT_RING.get());
                        output.accept(ModItems.WATER_ELEMENT_RING.get());
                        output.accept(ModItems.FIRE_ELEMENT_RING.get());
                        output.accept(ModItems.EARTH_ELEMENT_RING.get());
                        output.accept(ModItems.FIVE_ELEMENT_RING.get());
                    })
                    .build());
