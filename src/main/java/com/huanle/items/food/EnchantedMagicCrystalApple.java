...
public class EnchantedMagicCrystalApple extends Item {
    public EnchantedMagicCrystalApple(Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag flag) {
        tooltipComponents.add(Component.translatable("item.huanle.enchanted_magic_crystal_apple.desc"));
