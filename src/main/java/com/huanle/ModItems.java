...
import com.huanle.items.RuneBagItem;
...
import com.huanle.items.curios.FiveElementRing;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> HUANLE_SWORD = ITEMS.register("huanle_sword",
            () -> new HuanleSword(Tiers.NETHERITE, 18, -2.5F,
    ...
    public static final RegistryObject<Item> LAVA_SWORD = ITEMS.register("lava_sword",
            () -> new LavaSword(Tiers.NETHERITE, 6, -2.4F,
                    new Item.Properties().durability(3000).fireResistant()));

    public static final RegistryObject<Item> FIRE_GOD_SWORD = ITEMS.register("fire_god_sword",
            () -> new FireGodSword(Tiers.NETHERITE, 8, -2.6F,
                    new Item.Properties().durability(3000).fireResistant()));
    ...
    public static final RegistryObject<Item> DRAGON_HUNTER_SWORD = ITEMS.register("dragon_hunter_sword",
            () -> new DragonHunterSword(Tiers.NETHERITE, 13, -2.4F,
                    new Item.Properties().durability(3000)));
    ...
    public static final RegistryObject<Item> EARTH_SWORD = ITEMS.register("earth_sword",
            () -> new EarthSword(Tiers.NETHERITE, 13, -2.4F,
                    new Item.Properties().durability(3000)));
    ...
    public static final RegistryObject<Item> ABOMINABLE_GREATSABER = ITEMS.register("abominable_greatsaber",
            () -> new AbominableGreatsaber(Tiers.NETHERITE, 7, -2.6F,
                    new Item.Properties().durability(3000)));

    public static final RegistryObject<Item> VOID_ASH_BLADE = ITEMS.register("void_ash_blade",
            () -> new VoidAshBlade(Tiers.NETHERITE, 8, -2.6F,
    ...
    public static final RegistryObject<Item> FIRE_ELEMENT_RING = ITEMS.register("fire_element_ring",
            () -> new FireElementRing(new Item.Properties().rarity(Rarity.EPIC).stacksTo(1).fireResistant()));
            
    public static final RegistryObject<Item> EARTH_ELEMENT_RING = ITEMS.register("earth_element_ring",
            () -> new EarthElementRing(new Item.Properties().rarity(Rarity.EPIC).stacksTo(1)));
            
    public static final RegistryObject<Item> GOLD_ELEMENT_RING = ITEMS.register("gold_element_ring",
            () -> new GoldElementRing(new Item.Properties().rarity(Rarity.EPIC).stacksTo(1)));
            
    public static final RegistryObject<Item> WOOD_ELEMENT_RING = ITEMS.register("wood_element_ring",
            () -> new WoodElementRing(new Item.Properties().rarity(Rarity.EPIC).stacksTo(1)));
            
    public static final RegistryObject<Item> WATER_ELEMENT_RING = ITEMS.register("water_element_ring",
            () -> new WaterElementRing(new Item.Properties().rarity(Rarity.EPIC).stacksTo(1)));
            
    public static final RegistryObject<Item> FIVE_ELEMENT_RING = ITEMS.register("five_element_ring",
            () -> new FiveElementRing(new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1).fireResistant()));
            
    public static final RegistryObject<Item> METEORITE_RING = ITEMS.register("meteorite_ring",
            () -> new MeteoriteRing(new Item.Properties().rarity(Rarity.RARE).stacksTo(1)));
    ...
    public static final RegistryObject<Item> LIFE_RUNE = ITEMS.register("life_rune",
            () -> new Item(new Item.Properties().rarity(Rarity.RARE)));

    public static final RegistryObject<Item> WATER_RUNE = ITEMS.register("water_rune",
            () -> new Item(new Item.Properties().rarity(Rarity.RARE)));

    public static final RegistryObject<Item> CRIMSON_RUNE = ITEMS.register("crimson_rune",
            () -> new Item(new Item.Properties().rarity(Rarity.RARE)));
    
    public static final RegistryObject<Item> RUNE_BAG = ITEMS.register("rune_bag",
            () -> new RuneBagItem(new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
