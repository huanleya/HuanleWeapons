...
import net.minecraftforge.event.enchanting.EnchantmentModifyEvent;
...
public class EnchantmentEventHandler {
    ...
    // 使用EnchantmentModifyEvent来处理附魔修改
    @SubscribeEvent
    public static void onEnchantmentModify(EnchantmentModifyEvent event) {
